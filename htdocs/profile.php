    ...
    <?php foreach ($users as $username) : ?>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-4"><img src="../images/<?php echo $username["avatar"] ?>" alt="<?php echo $username["username"] ?>" style="width: 300px"></div>
                <div class="col-6">
                <p>
        ...
        <a href="password_change.php?id=<?php echo $_GET['id']?>" class="btn btn-danger" style ="width:150px;padding-left:50%;padding-right:50% ">Zmenit heslo</a>
    </div>
                </div></p>
